...
function applyTheme() {
    ...
    if (window.location.pathname.includes('consulta.html') || window.location.pathname.includes('dashboard.html') || window.location.pathname.includes('negotiation.html')) {
        if (theme) {
